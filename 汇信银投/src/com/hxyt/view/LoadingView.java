...
import com.hxyt.R;
import com.hxyt.utils.OptAnimationLoader;
...
//	mDialogAnim=(AnimationSet) OptAnimationLoader.loadAnimation(context, R.anim.modal_out);
...
//	    }
//	});
	View mView = LayoutInflater.from(context).inflate(R.layout.loading_view, null);
