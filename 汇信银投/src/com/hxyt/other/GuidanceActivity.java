...
public class GuidanceActivity extends Activity {
	...
	ImageView d = new ImageView(GuidanceActivity.this);
	d.setBackgroundResource(R.drawable.guide_image4);
	imageViews.add(a);
	imageViews.add(b);
	imageViews.add(c);
	imageViews.add(d);
	...
	flagView.get(flagTag).setBackgroundColor(Color.parseColor("#FAA49E"));
	flagView.get(position).setBackgroundColor(Color.CYAN);
	flagTag=position;
